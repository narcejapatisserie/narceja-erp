<template>
  <div class="space-y-5">
    ...
    <div class="card overflow-hidden">
      ...
      <div v-else-if="filteredProducts.length === 0" class="flex flex-col items-center justify-center py-16 text-gray-400">
      ...
      <table v-else class="w-full text-sm">
        <thead class="bg-gray-50 dark:bg-gray-800/50">
          <tr class="text-left text-gray-500 dark:text-gray-400">
            ...
            <th class="px-4 py-3 font-medium text-right hidden lg:table-cell">Custo</th>
            <th class="px-4 py-3 font-medium text-right hidden lg:table-cell">Margem</th>
        ...
        <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
          ...
          >
            ...
            <td class="px-4 py-3 text-right text-gray-600 dark:text-gray-400 hidden lg:table-cell">
            ...
            <td class="px-4 py-3">
              <div class="flex items-center justify-center gap-1">
                <RouterLink
                  ...
                  class="p-1.5 rounded hover:bg-blue-50 dark:hover:bg-blue-900/20 text-blue-600 transition-colors"
                ...
                <button
                  ...
                  class="p-1.5 rounded hover:bg-narceja-50 dark:hover:bg-narceja-900/20 text-narceja-600 transition-colors"
                  v-tooltip="'Editar'"
                >
                ...
                <button
                  ...
                  class="p-1.5 rounded hover:bg-red-50 dark:hover:bg-red-900/20 text-red-500 transition-colors"
                  v-tooltip="'Excluir'"
                >
